...
<body>
    ...
    <header>
        ...
        <div class="header-content container">
            <div class="content">
                <h1>Selecciona el apartado de tu interes</h1>
            </div>
    ...
    <div class="module-section">
        <div class="service">
        <a href="registro.php?nombre_boton=Conocimiento%20de%20seguridad%20vial"><h3>-Conocimiento de seguridad vial</h3></a>

        </div>
        <div class="service">
            <a href="registro.php?nombre_boton=Reglamentos%20y%20normativas%20de%20transporte%20público"><h3>-Reglamentos y normativas de transporte público</h3></a>
        </div>
        <div class="service">
            <a href="registro.php?nombre_boton=Señales%20de%20tráfico%20y%20su%20significado"><h3>-Señales de tráfico y su significado</h3></a>
        </div>
        <div class="service">
            <a href="registro.php?nombre_boton=Derechos%20y%20responsabilidades%20de%20los%20operadores"><h3>-Derechos y responsabilidades de los operadores</h3></a>
        </div>
    </div>
</main>
